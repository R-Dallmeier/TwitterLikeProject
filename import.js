...
const processFile = async () => {
    ...
    for await (const record of parser) {
        ...
        dbClient.query("INSERT INTO users (user_id,name,password,birthday,profile_pic,bio_text,created) VALUES ($1,$2,$3,$4,$5,$6,$7)", [record[0],record[1],record[2],record[3],record[4],record[5],record[6]], function(dbError,dbResponse){
